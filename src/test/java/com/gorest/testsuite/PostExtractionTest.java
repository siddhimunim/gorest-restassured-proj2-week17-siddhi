...
@Test
public void test006() {
    List<String> titleOfId = response.extract().path("findAll{it.user_id==5431}.title");
...
//7. Extract the body of all records whose id =2737
@Test
public void test007() {
    List<String> titleOfId = response.extract().path("findAll{it.id==2737}.body");
