...
public void test009() {
    ...
    System.out.println("------------------StartingTest---------------------------");
    System.out.println("  the ids of the object where gender = male" +status);
    System.out.println("------------------End of Test---------------------------");
}
//10. Get email of the object where name = Soma desai
    //dynemic data--------------//
@Test
public void test010() {
   String  email = response.extract().path("findAll{it.name='Soma Desai'}.email");
